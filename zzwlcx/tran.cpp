...
//#创建两个监听sock，每来一对sock，将其置于sock数据传递线程中.zzw.2016.3.7
//************************************************************************************
void bind2bind(int port1, int port2)
{
...
//#监听connectPort端口，每来一个sock，就将此sock与conn（th：tp）的sock置于sock数据传输线程中
//#.zzw
//************************************************************************************
void bind2conn(int port1, char *host, int port2)
{
...
//#不断地conn两个服务器，每次产生两个sock，置于sock数据传输线程中，在这两个socket之间传递数据；可以将一台机器提供的服务扩展到
//#计划提供的服务器上.zzw
//************************************************************************************
void conn2conn(char *host1,int port1,char *host2,int port2)
{
...
//************************************************************************************
// 
// Socket Transmit to Socket #在两个sock之间传递数据.zzw
//
//************************************************************************************
void transmitdata(LPVOID data)
{
